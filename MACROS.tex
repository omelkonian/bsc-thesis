...
\newcommand\optimization[2]{
	...
	\begin{minipage}[c]{0.2\linewidth} 
		\includegraphics[scale=0.15]{arrow} 
	\end{minipage}
	\begin{minipage}[c]{0.4\linewidth} 
...
% Source Code
\newmintedfile[hs]{hs}{frame=lines,framesep=0.5cm, linenos=true}
\newmintedfile[jv]{java}{frame=lines,framesep=0.5cm, linenos=true}
\newmintedfile[scala]{scala}{frame=lines,framesep=0.5cm, linenos=true}
\newmintedfile[scalas]{scala}{fontsize=\footnotesize,frame=lines,framesep=0.5cm, linenos=true}
\newmintedfile[jvs]{java}{fontsize=\footnotesize,frame=lines,framesep=0.5cm, linenos=true}
\newmintedfile[jvxs]{java}{fontsize=\tiny,frame=lines,framesep=0.5cm, linenos=true}
