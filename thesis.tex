...
While doing my internship at \textit{NCSR}, I realized that the goal I was pursuing was impossible to reach closure in a 6-month period by a mere undergraduate student. Therefore, I decided that everything should be implemented in a way that will allow future contributions. 
...
A very well-known and well-adapted framework for scalable large-data processing is Apache's \textit{Spark}\site{http://spark.apache.org/}. It was developed to overcome the shortcomings of the \textit{MapReduce} framework mentioned in section 6.1.1, providing a much more efficient and flexible runtime.
