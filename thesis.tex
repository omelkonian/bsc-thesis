...
%A detailed specification of the framework's characteristics and capabilities is given, followed by some robotic applications that demonstrate these attributes. Finally, related work and recent technologies are discussed.
...
\thesissubsection{System architecture}
...
\myimage{architecture}{0.5}{System architecture}
...
\thesissubsection{Supported dataflow graphs}
...
\thesissubsection{Stream language}
...
\thesissubsubsection{The Stream data type}
...
\thesissubsubsection{Graph construction syntax}
...
\thesissubsubsection{Evaluation syntax}
...
\thesissubsubsection{Execution semantics}
...
\myimage{strategy}{0.1}{Strategy design pattern}
...
\thesissubsection{External Input-Output} \label{external}
